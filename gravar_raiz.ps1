...
# Link da Live fixo
$LINK_VIDEO = "https://d38s7rrdbnh4oy.cloudfront.net/v1/master/215c0da80606fed29372070168106400a6ca7e1a/SSAI-Saudades/index.m3u8"

while ($true) {
    Clear-Host
    Escrever-Divisor -Cor White
    Escrever-Centro "GRAVAR +RAIZ" -Cor Cyan
    Escrever-Divisor -Cor White
    Write-Host ''
    ...
    $NOME_ARQUIVO = "MaisRaiz_$DataHora.ts"
    ...
    try {
        ...
        .\ffmpeg -user_agent "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Safari/537.36" -i $LINK_VIDEO -c copy -hide_banner -metadata service_name="+Raiz" -metadata service_provider="+SBT" $OutputPath 
    } catch {
